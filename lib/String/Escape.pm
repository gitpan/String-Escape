...
C<bug-string-escape at rt.cpan.org>, or through the web interface  
at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=String-Escape>.  
...
Allow escape specifications to contain = signs and optional arguments, so that users can request certain string lengths with C<escape("lowercase elide=20 quoted", @_>.
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=String-Escape>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/String-Escape>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/String-Escape>

=item * Search CPAN

L<http://search.cpan.org/dist/String-Escape/>
